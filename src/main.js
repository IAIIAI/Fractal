...
const powParams = `
      <label for="slider_pow" id="output_pow" class="orange"> Power: </label>
...
const julParams = `
      <br />
      <label for="slider_real" id="output_real" class="orange"> Real part: </label>
      ...
      <br />
      <label for="slider_imag" id="output_imag" class="orange"> Imaginary part: </label>
